...
import { AppBar, Container, Toolbar, Typography, Box, Menu, MenuItem, Button, Tooltip, Avatar, IconButton } from "@mui/material"; 
              ...
              <Box sx={{ flexGrow: 1, display: { xs: 'flex', md: 'none' } }}>
                ...
                sx={{
                  ...
                  <MenuItem key='marketplace' onClick={handleCloseNavMenu}>
                    <Typography textAlign="center"><NavLink to='/marketplace'>Marketplace</NavLink></Typography>
                  </MenuItem>
                  {isConnected ?
                  <MenuItem key='calendar' onClick={handleCloseNavMenu}>
                    <Typography textAlign="center"><NavLink to='/calendar'>Calendar</NavLink></Typography>
                  </MenuItem> : null}
                </Menu>
              </Box>
              <Typography
