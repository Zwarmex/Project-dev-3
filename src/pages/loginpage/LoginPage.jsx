    ...
    <div className="recipe__form-page">
      <div className="recipe__form-container">
        ...
        <div className="recipe__form-field__login">
          ...
          <input type="email" name="" id="" placeholder="Email"  alt="Write you email" title="Write your email"/>
        </div>
        <div className="recipe__form-field__password">
          <img src={cadenas} alt="cadenas-icon" />
          <input type="password" name="" id="" placeholder="Password" alt="Write you password" title="Write your password"/>
        </div>
        {register ? 
        <div className="recipe__form-field__password">
          <img src={cadenas} alt="cadenas-icon" />
